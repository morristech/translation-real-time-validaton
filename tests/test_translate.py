...
class TestTranslate(AsyncTestCase):
    ...
    def test_verify(self, mock_put):
        ...
        mock_put.assert_called_with('post', 'https://webtranslateit.com/api/projects/key/strings/locale/locales/3/translations', data={'minor_change': False, 'status': 'status_unverified', 'text': 'text'})
